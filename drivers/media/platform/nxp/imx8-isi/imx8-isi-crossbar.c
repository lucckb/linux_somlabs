					  ...
					  u32 remote_pad, unsigned int port)
{
    ...
    dev_dbg(xbar->isi->dev, "mxc_isi_crossbar_gasket_enable 1\n");

	if (!gasket_ops)
		return 0;

    dev_dbg(xbar->isi->dev, "mxc_isi_crossbar_gasket_enable 2\n");
    ...
    dev_dbg(xbar->isi->dev, "mxc_isi_crossbar_gasket_enable 3\n");
    ...
    dev_dbg(xbar->isi->dev, "mxc_isi_crossbar_gasket_enable 4\n");
					   ...
					   u32 pad, u64 streams_mask)
{
    ...
    dev_dbg(xbar->isi->dev, "mxc_isi_crossbar_enable_streams 3\n");
    ...
    dev_dbg(xbar->isi->dev, "mxc_isi_crossbar_enable_streams 4\n");
    ...
    dev_dbg(xbar->isi->dev, "mxc_isi_crossbar_enable_streams 5\n");
